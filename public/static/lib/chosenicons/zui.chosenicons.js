...
+ function($) {
    ...
    ChosenIcons.DEFAULTS = {
        ...
        icons: {
            ...
            other: ['desktop', 'laptop', 'tablet', 'mobile','code-fork', 'building', 'firefox', 'ie', 'opera', 'qq', 'lemon', 'sign-blank', 'circle', 'circle-blank', 'terminal', 'html5', 'android', 'apple', 'windows', 'weibo', 'wechat', 'renren', 'bug', 'moon', 'sun']
        }
    };
